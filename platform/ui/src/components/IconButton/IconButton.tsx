...
const variantClasses = {
  text: {
    default:
      'text-white hover:bg-black hover:text-white active:opacity-80 focus:!bg-black focus:text-white',
    primary:
  ...
  outlined: {
    default:
      'border bg-black text-white hover:opacity-80 active:opacity-100 focus:opacity-80',
    primary:
      'border border-primary-main text-primary-main hover:opacity-80 active:opacity-100 focus:opacity-80',
    secondary:
      'border border-bg-black text-bg-black hover:opacity-80 active:opacity-100 focus:opacity-80',
